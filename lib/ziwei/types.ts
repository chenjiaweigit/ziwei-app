...
export interface SelfSihuaMark { siHua: SiHua; starName: string; }
...
export interface DaXianSiHua { stemIndex: number; stemName: string; lu: string; quan: string; ke: string; ji: string; }
